<template>
	<div class="tab-bar">
		<ul>
			<li v-for="(item,index) in itemList" :key="item.id" class="tab-bar-item" :class="{active: index == isActive}" @click="addActive(index,item)">
		...
		data (){
			return {
				...
				itemList:[
					...
					{id:2,text:"作品",icon:"fa fa-smile-o",link:'/things'},
